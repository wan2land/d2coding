...
build: clear
	...
	# Ligature Regular
	cp $(d2coding_ligature_src).ttf fonts/d2coding-ligature-full.ttx
	...
	pyftsubset $(d2coding_ligature_src) \
	...
	# Ligature Bold
	cp $(d2coding_ligature_bold_src).ttf fonts/d2coding-ligature-bold-full.ttx
	...
	pyftsubset $(d2coding_ligature_bold_src) \
